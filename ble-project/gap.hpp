...
class CGap : private mbed::NonCopyable<CGap>, public ble::Gap::EventHandler {
    public:
        CGap(BLE& ble_interface, events::EventQueue& event_queue, const char* device_name) : 
        ble_interface_(ble_interface), event_queue_(event_queue), led(LED1), adv_builder_(buffer), 
